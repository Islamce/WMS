...
def approve_erp_allocate(rid, erp_token=erp):
    ...
    call('PATCH', f'/api/erp-operator/{rid}', erp_token, {'erp_reservation_number': f'RES-{rid}', 'movement_type': '201',
...
call('POST', f'/api/warehouse/{rid5}/assign-picker', supervisor, {'picker_id': pk['pickers'][0]['id']})
